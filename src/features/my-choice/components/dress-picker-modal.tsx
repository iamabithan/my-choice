...
import { DressFeature } from './shared';
...
export function DressPickerModal({
  ...
  const options = suggestedDress ? [suggestedDress] : dresses;
        ...
        <Pressable onPress={(event) => event.stopPropagation()}>
          ...
          {suggestedDress && (
            <View style={styles.modalActions}>
              <Pressable onPress={() => onPick(suggestedDress)} style={styles.primaryButton}>
                <ThemedText style={styles.primaryButtonText}>Confirm</ThemedText>
              </Pressable>
              <Pressable onPress={onChangeSuggestion} style={styles.secondaryButton}>
